...
//                self.channels.append(channel3)
                ...
                if let json = try! JSON(data: data).array {
                    ...
                    //print(self.channels[0].channelTitle!) //?? what the hell is going on?
//                    print(self.channels[1].channelTitle!) //?? what the hell is going on?
//                    print(self.channels[2].channelTitle!) //?? what the hell is going on?
//
                    completion(true)
